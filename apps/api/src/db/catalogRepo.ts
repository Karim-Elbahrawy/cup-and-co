...
const FALLBACK: CatalogResponse = {
  ...
  products: [
    p('22222222-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111103', 'Velvet Cappuccino',  'كابتشينو فيلفيت',     'Silky steamed milk over a double shot, dusted with cocoa', 65, '/images/products/velvet_cappuccino.png', 5, 1, 4.9, 128),
    p('22222222-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111103', 'Caramel Macchiato',  'كراميل ماكياتو',       'Espresso, vanilla, foam, and a caramel drizzle',           70, '/images/products/caramel_macchiato.png', 5, 2, 4.8, 96),
    p('22222222-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111103', 'Honey Latte',        'لاتيه عسل',           'Local honey blended with espresso and steamed milk',       68, '/images/products/honey_latte.png', 5, 3, 4.7, 64),
    p('22222222-0000-0000-0000-000000000004', '11111111-1111-1111-1111-111111111102', 'Vanilla Cold Brew',  'كولد برو فانيليا',     '12-hour cold brew, vanilla, over ice',                     62, '/images/products/vanilla_cold_brew.png', 3, 4, 4.8, 82),
    p('22222222-0000-0000-0000-000000000005', '11111111-1111-1111-1111-111111111101', 'Espresso Romano',    'إسبريسو رومانو',       'Double shot with a twist of lemon',                        45, '/images/products/espresso_romano.png', 3, 5, 4.6, 41),
    p('22222222-0000-0000-0000-000000000006', '11111111-1111-1111-1111-111111111102', 'Iced Americano',     'أمريكانو مثلج',       'Long espresso shaken over ice',                            50, '/images/products/iced_americano.png', 3, 6, 4.7, 73),
    p('22222222-0000-0000-0000-000000000007', '11111111-1111-1111-1111-111111111103', 'Mocha Royale',       'موكا رويال',           'Dark chocolate ganache, espresso, milk',                   75, '/images/products/mocha_royale.png', 6, 7, 4.9, 110),
    p('22222222-0000-0000-0000-000000000008', '11111111-1111-1111-1111-111111111103', 'Hazelnut Latte',     'لاتيه بندق',          'Roasted hazelnut syrup, espresso, milk',                   68, '/images/products/hazelnut_latte.png', 5, 8, 4.6, 58),
    p('22222222-0000-0000-0000-000000000009', '11111111-1111-1111-1111-111111111103', 'Spanish Latte',      'لاتيه إسباني',         'Espresso, condensed milk, steamed milk',                   70, '/images/products/spanish_latte.png', 5, 9, 4.8, 92),
    p('22222222-0000-0000-0000-00000000000A', '11111111-1111-1111-1111-111111111103', 'Flat White',         'فلات وايت',            'Double ristretto under silky microfoam',                   63, '/images/products/flat_white.png', 5, 10, 4.7, 67),
    p('22222222-0000-0000-0000-00000000000B', '11111111-1111-1111-1111-111111111107', 'Tiramisu Cup',         'كأس تيراميسو',         'Mascarpone, espresso-soaked ladyfingers, cocoa',           85, '/images/products/tiramisu_cup.png', 2, 1, 4.9, 88),
    p('22222222-0000-0000-0000-00000000000C', '11111111-1111-1111-1111-111111111107', 'Brownie Bar',          'براوني',                'Fudgy double-chocolate brownie',                           55, '/images/products/brownie_bar.png', 2, 2, 4.7, 74),
    p('22222222-0000-0000-0000-00000000000D', '11111111-1111-1111-1111-111111111107', 'Almond Croissant',     'كرواسون لوز',           'Buttery croissant filled with almond cream',               60, '/images/products/almond_croissant.png', 2, 3, 4.8, 56),
    p('22222222-0000-0000-0000-00000000000E', '11111111-1111-1111-1111-111111111107', 'Cheesecake Slice',     'تشيز كيك',              'New York style cheesecake, berry compote',                 70, '/images/products/cheesecake_slice.png', 2, 4, 4.8, 81),
    p('22222222-0000-0000-0000-00000000000F', '11111111-1111-1111-1111-111111111107', 'Chocolate Tart',       'تارت شوكولاتة',          'Dark chocolate ganache in butter pastry',                  65, '/images/products/chocolate_tart.png', 2, 5, 4.7, 49),
    p('22222222-0000-0000-0000-000000000010', '11111111-1111-1111-1111-111111111107', 'Cinnamon Roll',        'سينامون رول',            'Warm cinnamon roll with cream cheese glaze',               50, '/images/products/cinnamon_roll.png', 2, 6, 4.6, 42),
    p('22222222-0000-0000-0000-000000000011', '11111111-1111-1111-1111-111111111108', 'Avocado Toast',          'توست أفوكادو',           'Sourdough, smashed avocado, chili flakes, lemon',          80, '/images/products/avocado_toast.png', 7, 1, 4.7, 65),
    p('22222222-0000-0000-0000-000000000012', '11111111-1111-1111-1111-111111111108', 'Egg & Cheese Sandwich',  'ساندويتش بيض وجبنة',       'Scrambled eggs, melted cheese, on a toasted bun',          65, '/images/products/egg_cheese_sandwich.png', 6, 2, 4.6, 54),
    p('22222222-0000-0000-0000-000000000013', '11111111-1111-1111-1111-111111111108', 'Smoked Turkey Bagel',    'بيغل ديك رومي مدخن',        'Smoked turkey, swiss, mustard, on a fresh bagel',          75, '/images/products/smoked_turkey_bagel.png', 6, 3, 4.7, 48),
    p('22222222-0000-0000-0000-000000000014', '11111111-1111-1111-1111-111111111108', 'Granola Bowl',           'وعاء جرانولا',           'House granola, yogurt, seasonal fruit, honey',             70, '/images/products/granola_bowl.png', 5, 4, 4.8, 62),
    p('22222222-0000-0000-0000-000000000015', '11111111-1111-1111-1111-111111111108', 'Acai Bowl',              'وعاء آساي',              'Acai, banana, granola, fresh berries',                     90, '/images/products/acai_bowl.png', 5, 5, 4.9, 71),
    p('22222222-0000-0000-0000-000000000016', '11111111-1111-1111-1111-111111111108', 'Spinach Feta Wrap',      'راب سبانخ وفيتا',          'Spinach, feta, sundried tomatoes in spinach tortilla',     75, '/images/products/spinach_feta_wrap.png', 6, 6, 4.6, 38),
  ],
  offers: [
    {
      id: 'offer-today-70',
...
// ───────────────────────────────────────────────────────────────────────────
// Cup AI concierge — seed attributes for the bilingual rule-based matcher,
// applied in-place to FALLBACK.products at module load. When Supabase is
// configured these come off the products table directly (migration 0005);
// admins fill them in through the AttributesEditor.
// ───────────────────────────────────────────────────────────────────────────
const CONCIERGE_SEED: Record<string, Partial<Product>> = {
  ...
  // Desserts (low energy, sweet, no/little caffeine)
  ...
  // Breakfast (light, savoury, no caffeine)
...
// ───────────────────────────────────────────────────────────────────────────
// Cup AI admin overlay — admins set per-product attributes via the
// AttributesEditor. In Supabase mode, writes go straight to the products
// table (see setProductAttrs below); in fallback mode they live here.
// ───────────────────────────────────────────────────────────────────────────
...
/** Returns the merged (overlay-over-product) attributes for the matcher. */
...
/**
 * Persists admin-edited concierge attributes. In Supabase mode writes
 * straight to the products table so admin edits survive a server restart;
 * in fallback / dev mode merges into the in-memory overlay.
 */
