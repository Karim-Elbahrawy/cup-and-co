...
|-------|------|--------|--------|---------|-----------|-------|
| 1 | Observability & Compliance Foundation | `[~]` | 35% | 2026-05-07 | — | Sentry web+API done (PR #9); PostHog web+API done (PR pending); iOS portion of both deferred; Account-delete pending |
| 2 | Multi-Campus Architecture | `[ ]` | 0% | — | — | Schema-breaking; do early |
...
**Branch:** `claude/upgrade-p01-account-delete-export`
...
**Branch:** `claude/upgrade-p02-campus-schema`
...
**Dependencies:** 2.1
**Branch:** `claude/upgrade-p02-campus-selector`
...
**Branch:** `claude/upgrade-p02-migration-playbook`
